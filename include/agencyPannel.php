        ...
        <div class="Panel_container" id="mySidepanel">
            ...
            <li class="nav-item dropdown" style="color:#fff;">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li style="color:#333;"><a class="dropdown-item" href="messageriePro.php?id=<?= $_SESSION['pro_data']['pro_id'] ?>"><i class="fa-regular fa-comments" style="color:#333;"></i>Message</a></li>
