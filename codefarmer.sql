...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 09 nov. 2023 à 12:04
...
(63, 'coucou', 5, 10, '2023-11-08 00:00:00'),
(64, 'salut', 10, 5, '2023-11-08 00:00:00');
...
INSERT INTO `users` (`id`, `userName`, `mail`, `userPassword`, `date_naissance`, `ville`, `genre`, `date_inscription`, `date-connexion`, `statut`, `role`, `avatar`, `skill`, `lien_web`, `youtube`, `confirmkey`, `confirm`) VALUES
(5, 'Apex', 'j.hiroux456@gmail.com', '$argon2id$v=19$m=65536,t=4,p=1$d3NrRjNwaFdTbDVRSFJOdQ$gv8BxK7Zw3EpeYgn2HOBCHOT7n0gpBg/+PRkZra0FxA', '1989-01-13', 'Bruxelles', 'Homme', '2023-10-22 00:00:00', '0000-00-00 00:00:00', NULL, NULL, '5.jpg', 'html5 css3 javascript php mysql bootstrap github', 'https://apexdevweb.github.io/apexdev.github.io/', 'https://www.youtube.com/channel/UC_923NI-pI8Eu4chL1_tAhg', '', 0),
(10, 'sylvie', 'sylvie123@gmail.com', '$argon2id$v=19$m=65536,t=4,p=1$SXRHOUp1U3NjNlFKTnlMVg$K3Zb7H5ULwwTo42pfExx422LvZ78E5x9tiJxzrklAb0', '1991-08-10', 'Namur', 'Femme', '2023-10-30 00:00:00', '0000-00-00 00:00:00', NULL, NULL, '10.jpg', 'html5 css3 javascript nodejs react vueJs github', '', '', '', 0);
COMMIT;
