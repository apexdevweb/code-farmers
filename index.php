            ...
            <section class="premier_contenu">
                ...
                <div class="card carte_hov" style="width: 18rem; height: 13rem; background: url('asset/wallpapper/bgfive.jpg') no-repeat 50% 50%;background-size: cover;">
                    <div class="card-body">
                        ...
                        <hr>
                        <a href="home.php" style="font-family: Share Tech Mono, monospace; color: #fff; font-size: 2rem; text-shadow: 1px 2px 5px #000;">Visite</a>
                    </div>
                </div>
                <br>
                <!--glitch2-->
                <div class="card carte_hov" style="width: 18rem; height: 13rem; background: url('asset/wallpapper/bgerrer2.jpg') no-repeat 50% 50% ;background-size: cover;">
                    <div class="card-body">
                        ...
                        <hr>
                        <a href="signup.php" style="font-family: Share Tech Mono, monospace; color: #fff; font-size: 2rem; text-shadow: 1px 2px 5px #000;">Inscription</a>
                    </div>
                </div>
                <br>
                <!--glitch3-->
                <div class="card carte_hov" style="width: 18rem; height: 13rem; background: url('asset/wallpapper/bgtree.jpg') no-repeat 50% 50%;background-size: cover;">
                    <div class="card-body">
                        ...
                        <hr>
                        <a href="login.php" style="font-family: Share Tech Mono, monospace; color: #fff; font-size: 2rem; text-shadow: 1px 2px 5px #000;">Connexion</a>
                    </div>
                </div>
            </section>
        </section>
