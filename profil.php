...
if (isset($_SESSION['id'], $_GET['id']) && $_SESSION['id'] != $_GET['id']) {
                ...
                <div class="row">
                    <div class="col">
                        <div class="container-sm">
                            <img src="assets/usersimg/<?= $user_avatar_select; ?>" style="width: 300px; height: 300px; border-radius: 10px;">
                        </div>
                    </div>
                    <div class="col">
        ...
        <div class="cntrPubli">
            ...
            ?>
                ...
                <div class="responsive_carte">
                    <div class="card carte_hov" style="width: 15rem; height: auto; margin-top: 10px;background: url('assets/images/symbolehtml.jpg') no-repeat 50% 57%;background-size: cover;">
                        <div class="card-body">
                            ...
                            <br>
                            <img src="assets/userimgpubli/<?= $publication['img_publication'] ?>" style="width: 100%; height: 7rem; border-radius: 5px;">
